...
/**
 *clase para realizar los experimentos de ordenar con sort() de java y guardar los resultados en un CSV
 * @author ACR
 */
public final class MDOSort implements MetodoDeOrdenamiento {
    FileWriter datos;
    Ordenacion[] normal;
    Ordenacion[] ordenado;
    Ordenacion[] alrevez;
    ...
    long endTime;
    //constructor
    public MDOSort(Ordenacion[] normal,Ordenacion[] ordenado,Ordenacion[] alrevez) {
    ...
    {
        try{
        datos = new FileWriter("src//resources//resultados_sort.txt");  
        } catch(IOException e){ 
            System.out.println("Y archivo?");
        }
        datos.write("""
                    RESULTADOS DE EXPERIMENTOS CON SORT()
    ...
    /**
     * metodo para ordenar segun el tipo de ordenamiento que es
     * @param valores 
     */
    @Override
